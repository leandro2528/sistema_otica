    ...
    <div class="card-body">
            <form action="{{ route('clients.update', ['id'=>$client->id]) }}" method="POST">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" name="nome_completo" class="form-control" value="{{ $client->nome_completo }}">
                </div>
                ...
                <div class="row my-3">
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="date" name="data_nascimento" class="form-control" value="{{ $client->data_nascimento }}">
                    </div>
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="text" name="whatsapp" class="form-control" value="{{ $client->whatsapp }}">
                    </div>
                ...
                <div class="row my-3">
                    ...
                    <div class="col">
                        ...
                        <input type="text" name="observacoes" class="form-control" value="{{ $client->observacoes }}">
                    </div>
